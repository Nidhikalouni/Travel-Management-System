...
public class UpdateCustomer extends JFrame implements ActionListener {
    ...
    UpdateCustomer(String username){
        ...
        image.setBounds(480,70,250,350);
        add(image);
        ...
        public void actionPerformed(ActionEvent ae){
            if(ae.getSource() == add){
                ...
                try{
                    Conn c = new Conn();
                    String query = "update  customer set username='"+username+"',id='"+id+"', number = '"+number+"', name = '"+name+"', gender = '"+gender+"', email = '"+email+"',phone = '"+phone+"', country = '"+country+"', address = '"+address+"'";
