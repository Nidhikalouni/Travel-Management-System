...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    DeleteDetails(String username){
        ...
        lblemail.setBounds(500,50,150,25);
        add(lblemail);

        JLabel labelemail =  new JLabel();
        labelemail.setBounds(690,50,150,25);
        add(labelemail);
        ...
        lblcountry.setBounds(500,170,150,25);
        add(lblcountry);

        JLabel labelcountry =  new JLabel();
        labelcountry.setBounds(690,170,150,25);
        add(labelcountry);
        ...
        labeladdress.setBounds(690,230,150,25);
        add(labeladdress);
